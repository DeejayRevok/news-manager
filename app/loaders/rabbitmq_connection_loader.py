...
def load() -> None:
    rabbitmq_host = os.environ.get("NEWS_MANAGER_RABBIT__HOST")
    rabbitmq_port = os.environ.get("NEWS_MANAGER_RABBIT__PORT")
    rabbitmq_user = os.environ.get("NEWS_MANAGER_RABBIT__USER")
    rabbitmq_password = os.environ.get("NEWS_MANAGER_RABBIT__PASSWORD")
