...
from webapp.graph.graphql_views import setup_routes, schema, GRAPHIQL_JWT_TEMPLATE, error_formatter
...
class TestGraphViews(TestCase):
    ...
    """
    @patch('webapp.graph.graphql_views.AsyncioExecutor')
    @patch('webapp.graph.graphql_views.GraphQLView')
    @async_test
